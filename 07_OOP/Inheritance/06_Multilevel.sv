...
class food extends wild_animals;
  string food_type;
  
  function void eat();
    food_type = "carnivore";
    super.hunt();
    $display("food_type is %0s",food_type);
  endfunction
  
endclass

class group extends food;
  string group_name = "mammals";
  
  function void types();
    super.eat();
    $display("group_type %0s",group_name);
  endfunction
